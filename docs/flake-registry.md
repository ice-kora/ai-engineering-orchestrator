...
### FLAKE-001 复发记录（更新 2026-09-10）
- P2-03 全量回归（更新陈旧测试后复跑，19:30）：复发 1 次（102/7/1）；隔离复跑 2/2 全过，模式与首证一致。
- 另一次 P2-03 首跑（102/7/1）中的失败为陈旧测试断言（非本 flake），已按 P2-03 生命周期更新，见 docs/P2-03-REPORT.md 回归实录。
